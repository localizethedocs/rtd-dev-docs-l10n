...
foreach(_LANGUAGE ${LANGUAGE_LIST})
    ...
    execute_process(
        COMMAND ${CMAKE_COMMAND} -E env
                ...
                -j ${SPHINX_JOB_NUMBER}
                ${SPHINX_VERBOSE_ARGS}
                # https://sphinx-multiproject.readthedocs.io/en/latest/limitations.html#app-confdir-vs-app-srcdir
                ${PROJ_OUT_REPO_DOCS_CONFIG_DIR}                    # <configdir>, where conf.py locates.
...
set(UPSTREAM_DOCS   "https://docs.readthedocs.com/dev")
set(UPSTREAM_REPO   "https://github.com/readthedocs/readthedocs.org")
